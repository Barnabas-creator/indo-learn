...
// 显示注册用的邮箱是为了让用户报给管理员时对得上号。
export function renderCodePending(root, { email, onNext }) {
  root.innerHTML = shell('注册成功', '激活码已发送给管理员，请联系管理员获取', `
...
export function renderActivate(root, {
  onSubmit, onLogout, onRequestCode, error = '', busy = false, code = '', notice = '',
}) {
