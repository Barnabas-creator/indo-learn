...
| 课程学习 | BIPA A1 10 ＋ A2 12 ＋ B1 12 ＋ B2 10 单元，共 44 单元 / 132 课。每课含生词、情景对话、要点、小测 |
| 教材听力 | BIPA 官方录音 68 段 / 85 分钟（A1 33 ＋ A2 14 ＋ B1 12 ＋ B2 9），每段配转写、中译、听力题、表达法、生词、贴士 |
...
>
> **B1 同法**：`…/BIPA%20B1.zip`（2017-07-14 快照，8.9 MB），12 个 mp3，解到同目录 `B1-audio\`。
> 对应关系不是一对一：`unit 1& 2.mp3` 是第 1、2 课两段对话（中间隔一段音乐，0–33s / 44.5s 起），
> `unit13.mp3` 是 d'Masiv《Jangan Menyerah》的歌曲录音（第 12 课填词练习用），**是商业歌曲，不上架**。
>
> **B2 没有音频**：`…/BIPA%20B2.zip`（2017-07-14 快照，3.5 MB）里只有 PDF；B2 的「Menyimak」是让老师朗读课文，
> 书末也没有听力原文。**B2 听力改用 2019 新版**：教育部 BIPA 网站 bipa.kemendikdasmen.go.id 的
> 《Sahabatku Indonesia untuk Pelajar BIPA 4》（BIPA 4≈B2，id=ODU2）有 9 段官方录音＋书内原文，
> 录音在 `filebelajar/*.mp3`，课本 `openberkas.php?id=ODU2` → `filebelajar/706211Pelajar_BIPA_4_REV.pdf`，
> 已存到 `…/BIPA-Sahabatku-Indonesia/BIPA4-2019/`。跟 2016 版 B2 课程不是同一本书，听力单独成组。
> 同一网站还有 BIPA 1–7 全套 2019 版及录音。B2 课本有几处事实错误（哈达生日、海啸浪高、
> 《Hari Merdeka》作者、Dewi Sartika 建校年份），转写时已改正并在要点里注明。
